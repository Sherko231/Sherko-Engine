...
Phase 4 is the active M1 focus. P4-T01 / Issue #94 is accepted and establishes the canonical world convention in [`docs/SPATIAL_CONVENTIONS.md`](docs/SPATIAL_CONVENTIONS.md). P4-T02 / Issue #95 is accepted and pins/verifies JOML hot-loop use. P4-T03 / Issue #96 is accepted through PR #171 and provides cached hierarchical `Transform` composition plus public JOML spatial math ownership under D-042. P4-T04 / Issue #97 is the active executable task adding atomic self/indirect parent-cycle rejection while keeping P4-T05 child tracking/descendant dirty propagation separate.
