...
Phase 5 — Rendering foundation is now the current M2 focus. P5-T01 through P5-T09 are accepted, including the bounded public `OpenGlRenderer` indexed-draw path, window-owned presentation, explicit D-056 sRGB color path, and D-057 internal material/state policy. P5-T07A / Issue #213 repaired the renderer's public Gradle/API boundary without changing public signatures. P3-T04C / Issue #216, P5-T03A / Issue #221, and P5-T07B / Issue #224 are accepted maintenance repairs. P5-T10 / Issue #192 is active on `p5-t10-render-submission-packets`, adding D-058 immutable per-frame render submission snapshots without pulling P6 resource identities or P5-T11+ culling/sorting forward. The roadmap keeps 1080p60 as the initial performance target, but exact minimum CPU/GPU/driver/RAM/VRAM qualification is not a current gate and must not be claimed without separate future evidence.
