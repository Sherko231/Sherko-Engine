...
Phase 4 is the active M1 focus. P4-T01 / Issue #94 is accepted and establishes the canonical world convention in [`docs/SPATIAL_CONVENTIONS.md`](docs/SPATIAL_CONVENTIONS.md): right-handed world, +X right, +Y up, -Z forward, meters for linear world quantities, radians for internal angular quantities, right-hand-rule positive rotation, and dimensionless scale. P4-T02 / Issue #95 has been freshly audited and activated as the executable JOML hot-loop allocation task. Its implementation and acceptance state is live GitHub state; P4-T03 remains planned until #95 is accepted.
