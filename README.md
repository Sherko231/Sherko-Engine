...
Phase 4 is the active M1 focus. P4-T01 / Issue #94 through P4-T04 / Issue #97 are accepted: the engine has one canonical spatial convention, JOML ownership/allocation evidence, cached hierarchical `Transform`, and atomic transform-parent cycle rejection. P4-T05 / Issue #98 is the active executable task replacing the temporary parent-revision cache fallback with explicit dirty propagation only through the changed transform's descendants.
