...
- [Technical backlog](docs/roadmap/TECHNICAL_BACKLOG.md) — 217 stable implementation task IDs with acceptance criteria.
...
Implementation work should be taken from GitHub Issues for the active phase, not directly from the entire technical backlog.
