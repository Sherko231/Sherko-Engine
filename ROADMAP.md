...
P5R-T01 establishes the Phase 5R naming/refactor standard and repository-wide symbol inventory. After its acceptance, the next executable work must be freshly refined from **P5R-T02**, not P6-T01. Only after the Phase 5R exit review passes may P6-T01 be materialized. Exact task definitions and acceptance criteria remain in the [technical backlog](docs/roadmap/TECHNICAL_BACKLOG.md).
