...
P5R-T01 and P5R-T02 are accepted, establishing the Phase 5R naming/refactor standard, repository-wide symbol inventory, and public/internal/package boundary audit. **P5R-T03** is the active bounded refactor of `GlfwWindow` native/backend plumbing; P5R-T04 must not begin until T03 is accepted. P6-T01 remains blocked. Only after the Phase 5R exit review passes may P6-T01 be materialized. Exact task definitions and acceptance criteria remain in the [technical backlog](docs/roadmap/TECHNICAL_BACKLOG.md).
