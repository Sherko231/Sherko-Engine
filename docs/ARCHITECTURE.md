...
| `engine-assets` | Runtime asset identity, handles/formats, and loading contracts | P6-T01 through P6-T13 provide stable identity, strict source metadata, deterministic cooking/formats/dependencies, typed resource handles/fallbacks, and asynchronous manifest-backed MESH loading; caches/reference counting and other runtime asset types remain planned | `engine-core` |
