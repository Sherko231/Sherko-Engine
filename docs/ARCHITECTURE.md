...
| `engine-render-opengl` | OpenGL renderer and runtime-UI draw adapter | Bounded public indexed-mesh renderer plus internal P5-T03..T09 resource/upload/shader/uniform/sRGB/material-state foundations | `engine-core`, `engine-platform-lwjgl`, `engine-assets`, `engine-ui` |
