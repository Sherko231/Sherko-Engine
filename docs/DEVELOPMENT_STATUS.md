...
| Active executable task | None — P5-T15 / Issue #197 accepted; P5-T16 / #198 is the next planned activation |
...
Issue #182 and follow-up #201 are closed as not planned after the owner removed mandatory hardware benchmarking from the roadmap. P5-T01 / #183 through P5-T15 / #197 are accepted. P5-T16 / #198 is the next planned renderer-foundation task and must be freshly activated/refined against accepted P5-T15 before implementation.
...
Freshly activate/refine P5-T16 / Issue #198 against accepted P5-T15 and current `master` before implementation. P5-T16 may add only bounded renderer-neutral debug line/AABB/sphere/ray/text-counter submission through accepted renderer foundations; do not pull editor/ImGui runtime UI, physics/network implementations, retained debug-scene ownership, unbounded debug lifetimes, P5-T17 view models, or unrelated future tasks forward.
