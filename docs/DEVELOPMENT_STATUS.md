...
| Active executable task | None — P5-T10 / Issue #192 accepted; P5-T11 / #193 is the next planned activation |
...
Issue #182 and follow-up #201 are closed as not planned after the owner removed mandatory hardware benchmarking from the roadmap. P5-T01 / #183 through P5-T10 / #192 are accepted. P5-T11 / #193 is the next planned renderer-foundation task and must be freshly activated/refined against accepted P5-T10 before implementation.
...
Freshly activate/refine P5-T11 / Issue #193 against accepted P5-T10 and current `master` before implementation. P5-T11 may add only bounded CPU frustum culling over accepted P4 geometry and the P5-T10 submission boundary; do not pull P5-T12 sorting, P6 resource identities, world/ECS ownership, occlusion structures, or gameplay-specific renderer coupling forward.
