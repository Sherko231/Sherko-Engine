...
| Active executable task | P5-T07B / Issue #224 — restore sandbox renderer IDE module resolution; P5-T08 / Issue #190 remains PLANNED |
...
Complete P5-T07B / #224 before activating P5-T08. Restore Gradle/IntelliJ module resolution for the sandbox renderer dependency without weakening D-055's default API-only consumer boundary, and preserve headless-server isolation. P5-T08 / #190 remains PLANNED and must not be activated in this task.
