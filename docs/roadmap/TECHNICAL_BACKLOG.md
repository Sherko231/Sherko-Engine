...
- [ ] P5R-T25 Run the final consistency/dead-code/stale-name cleanup. Active via Issue #305: fresh audit on baseline `4bba10629e73a7899e2aac04f381db501773afd3` found no justified source/Gradle/resource/wiki/sandbox cleanup; the candidate is Markdown-only evidence that live obsolete names, avoidable compatibility aliases, and orphaned refactor scaffolding are absent while historical evidence identifiers remain intentionally preserved. Acceptance remains repository search with documentation and sandbox guidance matching final code.
