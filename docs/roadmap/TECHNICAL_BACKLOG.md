...
- [ ] P6-T08 Decode PNG/JPEG only in the cooker and generate mip chains. Acceptance: runtime loads the cooked texture without invoking image decoding. Active executable contract: Issue #383 from `master` `fff6c2356c9f949456627963a4880fe4a536ef71`; PNG/JPEG are decoded offline to RGBA8, deterministic complete mip chains are persisted as validated `STEX` v1, and P6-T09+ remain out of scope.
