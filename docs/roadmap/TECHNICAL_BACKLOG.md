...
- [ ] P6-T08 Decode PNG/JPEG only in the cooker and generate mip chains. Acceptance: runtime loads the cooked texture without invoking image decoding. Accepted through Issue #383 / PR #384; final head `29e65306385babf2a1e9c10c7b842a49e084acfa` passed run #553, merged as `51142468b8186a06b0fe73bfaac117843c065ff3`, and exact-merge Lightweight verification passed in run #554.
- [ ] P6-T09 Cook mono/stereo audio metadata and Vorbis payloads with validated sample rate/channel count. Acceptance: a malformed source is rejected by the cooker. Accepted through Issue #386 / PR #388; final head `7e6aabbfb58bddc84abd3a10c674c2a003d67221` passed run #579, merged as `4de4f3a9e9ca67857f9fe6f3b0bb159e4b6749d3`, and exact-merge Lightweight verification passed in run #580.
- [ ] P6-T10 Build a dependency graph from materials to textures/shaders and scenes/prefabs to their assets. Acceptance: recooking a texture invalidates only affected dependents. Accepted through Issue #390 / PR #391; final head `f831c9eb548b049ae284b353a9b308679914f1b1` passed run #586 / `35786375612`, merged as `7b5843968b58193f249f54f6d5665e7435f8fd37`, and exact-merge Lightweight verification passed in run #587 / `35786970766`.
- [ ] P6-T11 Implement `ResourceHandle<T>` with loading, ready, failed, and released states. Acceptance: gameplay cannot obtain an untyped native handle. Accepted through Issue #393 / PR #394; final head `b22258a8e9b7102de4c5ec14af987b751ca009ce` passed run #590 / `35849372952`, merged as `b761d15f07eaeeb2d082fc8e8dea53bfb641cefd`, and exact-merge Lightweight verification passed in run #591 / `35849980110`.
- [ ] P6-T12 Implement fallback mesh, texture, material, and sound assets. Acceptance: missing content yields visible/audible fallback and a structured error instead of a crash. Accepted through Issue #396 / PR #397; final head `1ceecab7225b863302231bb9243631d7dcaac971` passed run #594 / `35905886197`, merged as `f2919bb93c34b410e9a3dbf7707e5ecce850766f`, and exact-merge Lightweight verification passed in run #595 / `35906606650`.
- [ ] P6-T13 Implement asynchronous file read/decompression but perform GPU upload on the render thread. Acceptance: loading a large mesh does not call OpenGL off-thread. Active executable contract: Issue #399 from `master` `30250667d2f440d5c7b7f76837f022c000ef8633`; manifest-backed SMES read/decode runs on virtual workers while explicit OpenGL buffer upload remains guarded to the owner/render thread.
