...
- [ ] P6-T02 Define versioned source metadata for mesh, texture, material, skeleton, animation, audio, prefab, and scene assets. Acceptance: unknown versions fail with an upgrade-required message. Active executable contract: Issue #365, freshly refined from `master` `c9affeafcedd5a418f78727244103d3cf33724bd`; P6-T03+ remain out of scope.
