...
- [ ] P6-T05 Convert imported coordinates and units into the engine convention exactly once during cooking. Acceptance: a one-meter reference cube has a one-meter engine AABB. Active executable contract: Issue #374, freshly refined from `master` `1de28699ee81dd559260e6d9ee74f77081e0fbea`; P6-T06+ remain out of scope.
