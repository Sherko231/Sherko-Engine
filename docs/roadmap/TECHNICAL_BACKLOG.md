...
- [ ] P6-T12 Implement fallback mesh, texture, material, and sound assets. Acceptance: missing content yields visible/audible fallback and a structured error instead of a crash. Active executable contract: Issue #396 from `master` `53f094ccf7aaf6956deec87ec4c2ccbb8fe91bce`; deterministic CPU-side MESH/TEXTURE/MATERIAL/AUDIO fallback values complete typed handles READY and pair them with `AssetLoadErrorCode.MISSING_CONTENT`, while runtime file I/O/upload remains P6-T13.
