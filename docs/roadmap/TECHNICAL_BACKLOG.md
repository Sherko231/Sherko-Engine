...
- [ ] P5R-T17 Clean sandbox naming and legacy compatibility surface. Active via Issue #277: remove verified-obsolete `EngineDemoMain` / `runEngineDemo`, normalize nested `SandboxControls.Action/Input` names, retain T16 helper names, and keep canonical `runSandbox` behavior unchanged.
