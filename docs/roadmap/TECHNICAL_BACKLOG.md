...
- [ ] P6-T06 Generate missing tangents and reject meshes missing required UVs for tangent-space materials. Acceptance: errors include asset path and mesh name. Active executable contract: Issue #377, freshly refined from `master` `cb8b6c6bfae002b9b91358e81a6b11d6c681c686`; P6-T07+ remain out of scope.
