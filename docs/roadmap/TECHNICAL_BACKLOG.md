...
- [ ] P6-T14 Add development hot reload for shader and material assets only. Acceptance: a material edit appears without restarting and failed reload preserves the prior valid resource. Active executable contract: Issue #402 from `master` `5d00e69b81deccecf9f99dfcf1ae66ff7c03cd61`; MATERIAL uses strict schema v1 and polling-based last-valid-value replacement while renderer shader candidates swap only after successful compile/link.
