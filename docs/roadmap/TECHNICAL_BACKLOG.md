...
- [ ] P6-T07 Cook vertex/index streams into a documented binary schema with magic, schema version, counts, bounds, and checksum. Acceptance: corrupted payload is rejected before GPU upload. Active executable contract: Issue #380, freshly refined from `master` `90ca66df7ee89037181c9b8ef5d6d141f2833bde`; P6-T08+ remain out of scope.
