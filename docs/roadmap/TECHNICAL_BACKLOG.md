...
- [ ] P5R-T21 Perform the deliberate public-API naming pass after internals stabilize. Active via Issue #301: audit all 60 supported public top-level types, 15 supported nested public types, and their public member vocabulary; current candidate is KEEP-all with no public rename, source/wiki/sandbox change, or compatibility shim.
