...
- [ ] P6-T03 Implement a command-line asset cooker with one input directory and one output cache. Acceptance: clean cooking produces a manifest and nonzero cooked files. Active executable contract: Issue #368, freshly refined from `master` `6b787d259f1222cdc882d7c37091f5a8b06786fe`; P6-T04+ remain out of scope.
