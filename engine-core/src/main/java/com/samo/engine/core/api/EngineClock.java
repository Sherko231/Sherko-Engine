 ...
 *
 * <p>The first successful sample establishes the baseline and returns zero. Later samples return
...
public final class EngineClock {
     ...
     *
     * @param nanoTimeSource monotonic nanosecond source
     ...
     *
     * <p>The first successful sample returns zero. A negative signed elapsed difference is rejected
     ...
     * @throws IllegalStateException if the source regresses outside the supported elapsed range
     * @throws RuntimeException if the configured source throws one
     * @throws Error if the configured source throws one
     */
