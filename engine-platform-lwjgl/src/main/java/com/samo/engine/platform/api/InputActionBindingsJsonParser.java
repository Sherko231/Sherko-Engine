...
/** Parses the strict version-1 input-action binding JSON document. */
final class InputActionBindingsJsonParser {
    ...
    static InputActionBindings parse(Path path, Reader reader) throws IOException {
    ...
    private static InputBinding parseBinding(
        ...
        try {
            ...
            InputActionBindingsValidator.validateActionComponent(action, binding);
            return binding;
        } catch (IllegalArgumentException exception) {
