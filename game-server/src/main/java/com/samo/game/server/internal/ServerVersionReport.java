...
public final class ServerVersionReport {
    ...
    private static Properties loadProperties() {
        ...
        try (InputStream input = ServerVersionReport.class.getClassLoader().getResourceAsStream(RESOURCE)) {
            if (input == null) {
