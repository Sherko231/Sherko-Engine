...
| `OpenGlRenderer` | Bounded production OpenGL renderer composition: owns one known indexed triangle plus fixed renderer-internal P5-T09 material values, applies P5-T11 CPU frustum culling, and exposes latest-successful culling counters. |
