...
| Type | Purpose |
| --- | --- |
| `RenderFramePacket` | Immutable per-frame renderer submission snapshot that defensively copies view/projection matrices and framebuffer pixel dimensions; owns no native resources and retains no mutable world/gameplay objects. |
