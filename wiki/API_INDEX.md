...
| `RenderFramePacket` | Immutable per-frame renderer submission snapshot that defensively copies view/projection matrices, framebuffer pixel dimensions, and an ordered immutable local-light list; owns no native resources and retains no mutable world/gameplay objects. |
